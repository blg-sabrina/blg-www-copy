---
title: "كتالوج التطبيقات الكامل"
description: "دليل شامل لجميع تطبيقات BigLedger منظَّم حسب الوحدة والوظيفة"
...
تُعرَض هذه الصفحة بواسطة `layouts/applets/applet-catalog.html` من البيانات المنظَّمة
في المقدمة (front matter) أعلاه. حرّر المقدمة لتغيير الكتالوج.
